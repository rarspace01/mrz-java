...
/**
 * PTD format: Two row, 44 characters per line format.
 *
 * @author Maximilian Moser
 */
public class PTD extends MrzRecord {
    ...
    /**
     * Construct PTD Record.
     */
    public PTD() {
        super(MrzFormat.TRAVEL_PASS, "PTD");
    }
    ...
    public void fromMrz(final String mrz) throws MrzParseException {
        ...
        setValidDocumentNumber(parser.checkDigit(9, 1, new MrzRange(0, 9, 1), "travel document number"));
    ...
    public String toMrz() {
        ...
        sb.append("P");
        sb.append("T");
        sb.append(MrzParser.toMrz(getIssuingCountry(), 1));
